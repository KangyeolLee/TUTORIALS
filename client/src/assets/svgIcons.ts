export const svgIcons = {
  fileText: `<svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M13 12H5"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M13 16H5"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M7 8H6H5"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
  `,
  calendar: `<svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M17 3H3C1.89543 3 1 3.89543 1 5V19C1 20.1046 1.89543 21 3 21H17C18.1046 21 19 20.1046 19 19V5C19 3.89543 18.1046 3 17 3Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M14 1V5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M6 1V5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M1 9H19" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
  `,
  chart: `<svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13 17V7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M7 17V1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M1 17V11" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    `,
  check: `<svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  leftBtn: `<svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,
  rightBtn: `<svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  user: `<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,
  github: `<svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 24 24">
